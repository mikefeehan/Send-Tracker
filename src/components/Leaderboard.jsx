...
export default function Leaderboard({ drinks: rawDrinks, selectedFilter, onUserClick }) {
  ...
  const filterLabel = selectedFilter === 'today' ? 'Today' : 'this event'
          ...
          >
            ...
            <div className="flex-shrink-0">
              {user.profilePhoto ? (
                ...
                <div className={`rounded-full bg-gradient-to-br from-rose-500 to-purple-600 flex items-center justify-center text-white font-bold ${isFirst ? 'w-11 h-11 text-base' : 'w-10 h-10 text-sm'}`}>
            ...
            <div className="flex-1 min-w-0">
              <div className="flex items-center gap-1.5 flex-wrap">
                ...
                {movement === 'new' && (
                  <span className="text-xs font-bold bg-rose-500/20 text-rose-400 px-1.5 py-0.5 rounded-full tracking-wide">NEW</span>
                )}
              </div>
